...
public class GroupResource {
    ...
    @PUT
    @ApiOperation(
        value = "Adds a Group to a Topic in the Global Topology.",
        notes = "Adds a Group the the supplied specifications to a Topic in the Global Topology.",
        response = TopologyGroup.class,
        authorizations = "gts-groups-add"
    )
    @Timed
    public TopologyGroup<? extends Partition> add(@Versioned GroupSpecification specification) throws Exception {
    ...
    @ApiOperation(
            value = "Remove a Group from the Global Topology.",
    ...
    @ApiOperation(
            ...
            notes = "Retrieves all Producing and Consuming groups for a Topic with the given ID in the Global Topology.",
    ...
    @ApiOperation(
            ...
            notes = "Retrieves a Producing or Consuming group for a Topic with the given IDs in the Global Topology.",
    ...
    public TopologyGroup<?> get(@PathParam("topicId") String topicId, @PathParam("groupId") String groupId) throws Exception {
    ...
    /**
     * Represents all the Producer and Consumer Groups in a Topic.
     */
    @XmlRootElement
