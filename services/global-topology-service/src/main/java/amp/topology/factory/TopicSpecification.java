 ...
 */
public class TopicSpecification extends CommonSpecification {

    boolean createDefaults = true;

    protected TopicSpecification(){}

    /**
     * Initialize with the required parameters for specifying a Topic.
     ...
     * @param createDefaults Should any of the default topology or configuration be applied to this Topic.  If
    ...
    /**
     * If the Topic Configuration supports a default route set (or something else), should that route set be created?
    ...
    /**
     * A Builder for the TopicSpecification class.
     */
    public static class TopicSpecificationBuilder
            extends CommonSpecificationBuilder<TopicSpecification, TopicSpecificationBuilder> {

        protected TopicSpecificationBuilder() {  super(new TopicSpecification()); }
