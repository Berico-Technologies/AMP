...
import amp.topology.factory.CommonSpecification;
 ...
 */
public abstract class CommonSpecification_3_3_0 implements CommonSpecification {
    ...
    protected CommonSpecification_3_3_0(){}
     ...
     */
    public CommonSpecification_3_3_0(
            String topicId,
    ...
    /**
     * ID of the BasicTopic.  This must be unique within the BasicTopic space. Typically, this corresponds
     * to the type of event being produced or consumed (e.g. amp.events.UserPrivilegesRevokedEvent).
     * @return BasicTopic ID.
     */
    @Override
     ...
     */
    public static class CommonSpecificationBuilder<T extends CommonSpecification_3_3_0, B extends CommonSpecificationBuilder<T, B>> {
